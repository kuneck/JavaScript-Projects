...
const Calculator = {
    ...
    Display_Value: '0',
    //hold the first operand for any expressios
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    //overwrite Display_Value if the current value is 0, otherwise ot adds onto it
        Calculator.Display_Value = Display_Value === '0' ? digit : Display_Value + digit;
    }
}
//this section handles decimal points
function Input_Decimal(dot) {
    //ensures that accidental clicking of the decimal point doesnt cause bugs in operation
...
function Handle_Operator(Next_Operator) {
    ...
    //when an operator key is pressed, convert the current number displayed on the screen
    // to a number and then store the result in Calculator.First_operand if it doesnt already exist
